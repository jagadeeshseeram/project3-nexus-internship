...
function s23()
{
  ...
  let ttl="Brut Original Deodorant For Men";
  let price=999;
  addtocarteachitem(image,ttl,price);
}
function giveaway()
...
let price=document.getElementById("price");
     ...
     frequentitems.forEach(frequent => {
      frequent.addEventListener('click', function handleClick() {
        ...
        if(frequent.src=="https://m.media-amazon.com/images/I/41uzZhAEYIL._AC_UL600_FMwebp_QL65_.jpg")
        {
          producttitle.innerHTML="spider bag";
        ...
        else if(frequent.src=="https://m.media-amazon.com/images/I/61Yi8xC7q6L._AC_UL600_FMwebp_QL65_.jpg")
        {
          producttitle.innerHTML="one pluse watch";
        ...
        else if(frequent.src=="https://m.media-amazon.com/images/I/71zrfs7RazL._AC_UL600_QL65_.jpg")
        {
          producttitle.innerHTML="boat speaker";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=6000;
            price.innerHTML=5099;
        }
        else if(frequent.src=="https://m.media-amazon.com/images/I/515cYHh8YgL._AC_UL600_QL65_.jpg")
        {
          producttitle.innerHTML="cooling speticals";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=2000;
            price.innerHTML=999;
        }
        
        else if(frequent.src=="https://m.media-amazon.com/images/I/41D8WgA855L._AC_UL600_QL65_.jpg")
        {
          producttitle.innerHTML="phillips trimmer";
        ...
        else if(frequent.src=="https://m.media-amazon.com/images/I/712bOdOCJ3L._AC_UL600_QL65_.jpg")
        {
          producttitle.innerHTML="Doll";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=5000;
            price.innerHTML=2599;
        }
        else if(frequent.src=="https://m.media-amazon.com/images/I/71I1xrgIiRL._AC_UL600_QL65_.jpg")
        {
          producttitle.innerHTML="shakker";
        ...
        {
          producttitle.innerHTML="showcase decarations";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=800;
            price.innerHTML=410;
        }
